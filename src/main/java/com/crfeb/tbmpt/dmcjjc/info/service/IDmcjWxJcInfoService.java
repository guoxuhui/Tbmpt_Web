 ...
 *
 */
public interface IDmcjWxJcInfoService extends ISuperService<JcInfo>{
	...
	//给导入文件里的监测点计算变化量
	public List<DmcjJcInfoDetailsDto> addCalcBhl( Map<String,Map<String,String>> list,String  jcTime,String pid);
	//计算变化率
