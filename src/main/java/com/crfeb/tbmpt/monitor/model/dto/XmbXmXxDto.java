...
public class XmbXmXxDto  implements Serializable {
     ...
     * 线路信息
     */
    private List<XmbXmXlXxDto> xlList;
     ...
     * 线路信息
     */
	public List<XmbXmXlXxDto> getXlList() {
		return xlList;
	}
	/**
     * 线路信息
     */
	public void setXlList(List<XmbXmXlXxDto> xlList) {
		this.xlList = xlList;
	}
