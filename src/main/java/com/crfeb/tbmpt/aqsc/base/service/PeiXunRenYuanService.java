 ...
 * @author wangbinbin
 */
public interface PeiXunRenYuanService extends ICommonService<PeiXunRenYuan>{
    ...
    /**
     * 新增培训人员管理
     * @param peiXunRenYuan 要保存的实体
     */
    String save(PeiXunRenYuanDto peiXunRenYuanDto,User user) throws Exception;
    ...
    /**     * 修改培训人员管理
     * @param peiXunRenYuan 要修改的实体
     */
    String update(PeiXunRenYuanDto peiXunRenYuanDto,User user) throws Exception;

   /**
     * 通过ID查找培训人员管理
     * @param id 数据ID
     */
    PeiXunRenYuan findById(String id) throws Exception;

	/**
	 * 校验当前字段是否已存在
	 * @param peiXunRenYuan 实体信息
	 * @param clumName 需校验的字段
	 * @return 若为null则不重复，若不为null则重复
	 */
	String checkClumIfexits(PeiXunRenYuanDto peiXunRenYuanDto, String[] clumNames) throws Exception;
