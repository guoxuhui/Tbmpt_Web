 ...
 * 子模块路径
 */
var module = "zsJkJtdgSgRyTrXx";
/**
 * 模块名称
 */
var moduleName = "盾构施工人员投入信息";
/**
 * 名称字段
 */
...
$(function() {
	...
	dataGrid = $('#dataGrid').datagrid({
		...
		columns:[[
			...
			{width : '150',title : '当前项目总数',field : 'xmZrs',sortable : true}, 
			{width : '150',title : '当前盾构队总数',field : 'dgdZs'},
			{width : '150',title : '当前盾构队人员总数',field : 'dgdZrs'}, 
			{width : '150',title : '平均每个盾构队人数',field : 'dgdPjrs'}            
		     ]],
