/**
 * 界面显示接口信息管理：集团角度 主要设备投入情况信息实体信息
 * 
 * 创建时间：2017年03月13日 
 * 
 */
 ...
 * 子模块路径
 */
var module = "zsJkJtZySbTrXx";
/**
 * 模块名称
 */
var moduleName = "主要设备投入情况信息";
...
$(function() {
	...
	dataGrid = $('#dataGrid').datagrid({
		...
		columns:[[
			...
			{width : '150',title : '设备类别',field : 'sbLb',sortable : true}, 
			{width : '150',title : '租入数量',field : 'zrSl'},
			{width : '150',title : '租出数量',field : 'zcSl'}, 
			{width : '150',title : '检修数量',field : 'jxSl'}, 
			{width : '150',title : '运行数量',field : 'yxSl'}, 
            {width : '150',title : '运输数量',field : 'ysSl'}            
		     ]],
