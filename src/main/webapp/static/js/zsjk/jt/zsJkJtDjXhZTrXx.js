 ...
 * 子模块路径
 */
var module = "zsJkJtDjXhZTrXx";
/**
 * 模块名称
 */
var moduleName = "刀具消耗总投入信息";
...
$(function() {
	...
	dataGrid = $('#dataGrid').datagrid({
		...
		columns:[[
			...
			{width : '150',title : '刀具消耗计划投入值',field : 'jhTrz'},
			{width : '150',title : '刀具消耗实际投入值',field : 'sjTrz'}         
		     ]],
