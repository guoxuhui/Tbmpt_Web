 ...
 * 子模块路径
 */
var module = "zsJkJtXmxx";
/**
 * 模块名称
 */
var moduleName = "项目信息实体信息";
...
$(function() {
	...
	dataGrid = $('#dataGrid').datagrid({
		...
		frozenColumns: [ [
			...
			{width : '200',title : '项目名称',field : 'xmMc',sortable : true},
			{width : '200',title : '项目Id',field : 'xmId'} 
			]],
		columns:[[     
			{width : '150',title : '项目负责人',field : 'fzr'},
			{width : '150',title : '中标价格',field : 'zbjg'}, 
			{width : '150',title : '项目产值',field : 'xmcz'},
			{width : '150',title : '当前项目完成产值',field : 'dqxmwcz'}, 
            {width : '150',title : '城市地区',field : 'csdq'},  
			{width : '150',title : '坐标经度',field : 'zbjd'},
			{width : '150',title : '坐标纬度',field : 'zbwd'},
			{width : '150',title : '总工期天数',field : 'zts'}, 
			{width : '150',title : '开工日期',field : 'kgrq'}, 
            {width : '150',title : '预计完成日期',field : 'yjwcrq'}, 
			{width : '150',title : '地铁线路',field : 'dtxl'},
			{width : '150',title : '施工标段',field : 'sgbd'}, 
			{width : '150',title : '总环数',field : 'zhs'}, 
			{width : '150',title : '当前掘进总环数',field : 'dqjzjhs'}
