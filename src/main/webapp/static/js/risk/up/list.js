			...
			{width : '260',title : '风险描述',field : 'rikeDesc',
				formatter: function(value,row,index){
                    if(value!="" && value!=undefined){ 
                        ...
                        var tmpstr="风险描述："+valueSplit[0]+"\r\n管控措施："+row.mainControlMethod;
			...
			$('#add_persoon').combotree({
		        ...
		        onLoadSuccess: function (node, data) {
					if(data ==null || data.length <= 0){
						$.messager.alert('提示', '该项目部门下无人员！', 'info');
					}
...
$('#search_startUpTime').datebox('setValue', formatterDate(new Date(),"start"));
$('#search_endUpTime').datebox('setValue', formatterDate(new Date(),"end"));
};

$(function() {
    var curr_time = new Date();
//    $("input[name='startUpTime']").datebox('setValue', myformatter1(curr_time));
    $("input[name='endUpTime']").datebox('setValue', myformatter1(curr_time));
    
    $("#search_startUpTime").datebox('setValue', myformatter1(curr_time));
//    $("#search_startUpTime").datebox({
//        value : myformatter1(curr_time)
//    });
//    $("#search_endUpTime").datebox({
