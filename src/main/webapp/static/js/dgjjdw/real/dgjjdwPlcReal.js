 ...
 * 子模块路径
 */
var module = "dgjjdwPlcReal";
/**
 * 模块名称
 */
var moduleName = "盾构机机器数据实时信息";

/**
 * 业务数据访问全路径
 */
var path = basePath +"/"+ syspath +"/real/"+ module;
/**
 * 列表对象
 */
var dataGrid;
$(function() {
	...
	dataGrid = $('#dataGrid').datagrid({
		...
		frozenColumns: [ [
			...
			{width : '250',title : '点位编号',field : 'id',sortable : true},
			{width : '150',title : '盾构机ID',field : 'tbmid',sortable : true} 
			]],
		columns:[[
			
			{width : '150',title : '盾构机CODE',field : 'tbmcode',sortable : true}, 
			{width : '250',title : '工业库点位名称',field : 'tagname',sortable : true},
			{width : '150',title : '工业库点位数据类型',field : 'tagtype',sortable : true}, 
			{width : '150',title : '工业库点位值',field : 'tagvalue'},
			{width : '150',title : '时间',field : 'tagtime',sortable : true},
