        ...
        <div id="main">
            ...
            <div id="kg1">
                <div id="part1" class="leftImg">
                	<a onClick="showReport('/mb/match.rpx','1','404A59')">
                    <img src="images/icon1.png"/>
                    <p class="tt">按宽自适应</p>
                    </a>
                </div>
                <div id="part2" class="rightImg">
                <a onClick="showReport('/mb/match.rpx','2','404A59')">
             ...
             <div id="kg2">
                ...
                <a onClick="showReport('/mb/match.rpx','3','404A59')">
                    <img src="images/icon3.png"/>
                    <p class="tt">竖按高，横按宽</p></a>
                </div>
                <div id="part4" class="rightImg">
                <a onClick="showReport('/mb/match.rpx','4','404A59')">
			 ...
			 <div id="kg3">
                ...
                <a onClick="showReport('/mb/match.rpx','5','404A59')">
                    <img src="images/icon5.png"/>
                    <p class="tt">竖屏宽高自适应<br>横屏无自适应</p></a>
                </div>
                <div id="part6" class="rightImg">
                <a onClick="showReport('/mb/match-2.rpx','6','404A59')">
             ...
             <div id="kg4">
                ...
                <a onClick="showReport( '/mb/列宽自适应.rpx' )">
              ...
              <div id="kg5">
                ...
                <a onClick="showParam( '/mb/下拉联动_arg.rpx', '/mb/下拉联动.rpx' )">
                    <img src="images/icon9.png"/>
                     <p class="tt">参数表单</p></a>
                </div>
                <div id="part10" class="rightImg">
                <a onClick="showReport( '/mb/phone.rpx' )">
            ...
            <div id="chartsImg">
                <a onClick="showReport('/mb/phone_1.rpx','1','000000')">
					<div class="more">
						<img src="images/mb-1.png">
					</div>
				</a>
				<!--<a onClick="showReport('/mb/phone_2.rpx','1','000000')">
					<div class="more">
						<img src="images/mb-2.png">
					</div>
				</a>
				-->
				<a onClick="showReport('/mb/phone_3.rpx','1','000000')">
					<div class="more">
						<img src="images/mb-3.png">
					</div>
				</a>
				
				<a onClick="showReport('/mb/phone_4.rpx','1','F6F6F6')">
					<div class="more">
