              ...
              <ul class="sidebar-menu">
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li ><span class="label label-danger pull-right mail-info">新</span><a class="" href="javascript:show('/dashboard/设备故障分析.rpx')">设备故障分析</a></li>
						  <li><span class="label label-danger pull-right mail-info">新</span><a class="" href="javascript:show('/dashboard/dashboard-手机销售.rpx')">手机销售</a></li>
					  </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="javascript:show('/基本报表/交叉报表.rpx')">交叉报表</a></li>
						  ...
						  <li><a class="" href="javascript:show('/基本报表/多源分片.rpx&scroll=yes')">多源分片</a></li>
						  <li><a class="" href="javascript:show('/基本报表/库间关联.rpx')">库间关联</a></li>

						  <li><a class="" href="javascript:showJsp('/demo/reportJsp/showReportGroup.jsp?rpg=基本报表/报表组.rpg','基本报表/报表组.rpg')">报表组</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="javascript:show('/参数表单/下拉联动.rpx')">下拉联动</a></li>
                          <li><a class="" href="javascript:show('/参数表单/下拉树.rpx')">下拉树</a></li>

						  <li><a class="" href="javascript:show('/参数表单/复选框.rpx')">复选框</a></li>
						  <li><a class="" href="javascript:show('/参数表单/单选按钮.rpx')">单选按钮</a></li>
						  <li><a class="" href="javascript:show('/参数表单/subway.rpx')">地铁综合查询</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><span class="label label-danger pull-right mail-info">新</span><a class="" href="javascript:show('/特色报表/动态列.rpx')">自定义分析-动态列</a></li>
                          ...
                          <li><a class="" href="javascript:show('/特色报表/横向分栏.rpx')">横向分栏</a></li>
