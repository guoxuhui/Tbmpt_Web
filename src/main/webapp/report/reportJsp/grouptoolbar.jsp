...
<div class="btnBar">
  <ul class="left">
    ...
    <li class="toggleBg borderRight">
      <ul class="fileOper">
        <li><a class="ICOhover" href="#" onClick="group_print('group1');return false;"><span title="打印" class="print"></span></a></li>
		...
		<li><a class="ICOhover" href="#" onClick="group_exportMht('group1');return false;"><span title="导出mht" class="mht"></span></a></li>
      </ul>
    </li>
