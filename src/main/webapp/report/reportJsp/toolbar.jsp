  ...
  <ul class="left">
    <li class="toggleBg borderRight">
      <ul class="fileOper">
        ...
        <li><a class="ICOhover" href="#" onClick="printReport('report1');return false;"><span title="打印预览" class="print"></span></a></li>
		<li><a class="ICOhover" href="#" onClick="flashPrintReport('report1');return false;"><span title="flash打印预览" class="flashprint"></span></a></li>
