        ...
        <div class="page__bd">
            ...
            <div class="slide" id="slide1">
                <ul>
                    <li><>
                        <a href="javascript:;">
                            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="${staticPath}/static/open/images/gczl/gczl_ad1.jpg" alt="">
                        </a>
                        <div class="slide-desc">关爱生命 安全生产</div>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="${staticPath}/static/open/images/gczl/gczl_ad2.jpg" alt="">
                        </a>
                        <div class="slide-desc">施工安全警示标志</div>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="${staticPath}/static/open/images/gczl/gczl_ad3.jpg" alt="">
                        </a>
            ...
            <div class="weui-panel">
                ...
                <div class="weui-panel__bd">
                    ...
                    <div class="weui-grids">
                        ...
                        <a href="javascript:Android.onJump('com.crfeb.tbmpt.app.GczlGPDCLSXActivity');" class="weui-grid">
                            <div class="weui-grid__icon">
                                <i class="iconfont icon-duanxin"></i>
                                <span class="weui-badge" style="position: absolute;top: +.4em;right: +.4em;">1</span>
                            </div>
                            <p class="weui-grid__label">管片待处理事项</p>
                        </a>
                        ...
                        <a href="javascript:Android.onJump('com.crfeb.tbmpt.app.GczlSGDCLSXActivity');" class="weui-grid">
                            <div class="weui-grid__icon">
                                <i class="iconfont icon-duanxin"></i>
                                <span class="weui-badge" style="position: absolute;top: +.4em;right: +.4em;">1</span>
                            </div>
                            <p class="weui-grid__label">施工待处理事项</p>
                        </a>
