		...
		<div class="page input js_show">
			...
			<div class="page__bd">
				...
				<form id="form" method="post"
					action="${staticPath}/open/gczl/gczlSGZLXJAddDo"
					...
					<div class="weui-cells weui-cells_form">
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								${pro.name} <input name="gcBh" type="hidden" value="${pro.id}" />
							</div>
						</div>
					...
					<div class="weui-cells weui-cells_form">
						<div class="weui-cell">
							<div class="weui-cell__hd">
								<label for="" class="weui-label" style="width: 8em;">巡检时间：</label>
							</div>
							<div class="weui-cell__bd">
								<input name="xjTime" class="weui-input" type="datetime-local"
									placeholder="请输入巡检时间" required />
							</div>
						</div>
						<div class="weui-cell weui-cell_select weui-cell_select-after">
							<div class="weui-cell__hd">
							...
							<div class="weui-cell__bd">
								<select id="sgNr" name="sgNr" class="weui-select">
						...
						<div class="weui-cell weui-cell_select weui-cell_select-after">
							...
							<div class="weui-cell__bd">
								<input class="weui-input" value=""
									style="position: absolute; top: 10px; width: 50%;"
									id="jtWz_input" /> 
									<select id="jtWz" name="jtWz"
									class="weui-select" >
									<c:forEach items="${dic}" var="dic">
						...
						<div class="weui-cell weui-cell_select weui-cell_select-after">
							...
							<div class="weui-cell__ft">
			                    <button class="weui-vcode-btn" id="showPicker">选择</button>
			                </div>
						</div>

						<div class="weui-cell">
							<div class="weui-cell__hd">
								<label for="" class="weui-label" style="width: 8em;">施工工段：</label>
							</div>
							<div class="weui-cell__bd">
								<input name="sgd" class="weui-input" type="text" value=""
									placeholder="请输入施工工段" required />
							</div>
						</div>
						<div class="weui-cell">
							<div class="weui-cell__bd">
								<textarea name="remarks" class="weui-textarea"
									placeholder="请输入其他内容" rows="3"></textarea>
									...
									<div class="weui-uploader__bd">
										...
										<div class="weui-uploader__input-box">
											<input id="uploaderInput" class="weui-uploader__input"
												name="file" type="file" accept="image/*" multiple />
										</div>
									</div>
								</div>
							</div>
	...
	<script type="text/javascript">
        $(function(){
            var tmpl = '<li class="weui-uploader__file" style="background-image:url(#url#)"></li>',
                ...
                $jtWz = $("#jtWz"),
                $zlQx = $("#zlQx"),
                $jtWz_input = $("#jtWz_input"),
                $zlQx_input = $("#zlQx_input")
                ;
	        ...
	        $jtWz.on("change", function(e){
	    			 var text = e.target.value;
	    			 var input = document.getElementById("jtWz_input");
	    			 e.target.text = "";
	    			 input.value = text;
	    			 input.focus()
	        ...
	        $zlQx.on("change", function(e){

	    			 var text = e.target.value
	    			 var input = document.getElementById("zlQx_input");
	    			 e.target.text = "";
	    			 input.value = text;
	    			 input.focus()
	    		
	        });
	        $jtWz_input.on("change", function(e){
	    			var input = document.getElementById("jtWz_input");
	    			 var select = document.getElementById("jtWz");
	    			 select.value = input.value;

	        });
	        $zlQx_input.on("change", function(e){
	    			var input = document.getElementById("zlQx_input");
	    			 var select = document.getElementById("zlQx");
	    			 select.value = input.value;
