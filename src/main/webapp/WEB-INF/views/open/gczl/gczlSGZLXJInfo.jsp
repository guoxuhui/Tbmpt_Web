...
<body ontouchstart>
				...
				<div class="weui-form-preview">
					...
					<div class="weui-form-preview__bd">
						...
						<div class="weui-form-preview__item">
							<label class="weui-form-preview__label">巡检内容</label> <span
								class="weui-form-preview__value">${info.sgNr}<br/>${info.jtWz}<br/>${info.zlQx}</span>
						</div>
					...
					<c:choose>
						<c:when test="${info.sbZt == '未上报' }">
                			...
                			action="${staticPath}/open/gczl/gczlSGZLXJSB">
						...
						<c:when test="${info.shZt == '未审核' }">
                			...
                			action="${staticPath}/open/gczl/gczlSGZLXJSH">
						...
						<c:when test="${info.zgZt == '未整改' }">
							...
							<form id="form_dzg" method="post" 
                				action="${staticPath}/open/gczl/optSGZgTx">
                				
                				<input name="id" type="hidden" value="${info.id}"/>
                				
								<div class="weui-cells__title">待整改提醒，重新提示整改人员</div>
								<div class="weui-btn-area">
									<a class="weui-btn weui-btn_primary" href="javascript:"
										id="formSubmitBtn_dzg">待整改提醒</a>
								</div>
                			...
                			action="${staticPath}/open/gczl/gczlSGZLXJZG"
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#formSubmitBtn_dzg").on("click", function() {
				$form_dzg.validate(function(error) {
					if (error) {
						$('#dialogTip_content').empty();
						$('#dialogTip_content').append("请完善输入框");
						$dialogTip.fadeIn(200);
