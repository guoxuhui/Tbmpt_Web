...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#addForm').form({
            ...
            onSubmit : function() {
                ...
                if("未确认" == ifqr){
                	parent.$.messager.alert('提示', '请先确认再上报', 'info');
                  return false;
                }
    ...
    function addEditFun(id) {
        parent.$.modalDialog({
            ...
            height : 500,
            maximizable:true,
            href : '${path}/dmcjjc/bgsb/tempsave?id=' + id,
            buttons : [{
                text : '保存',
                handler : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
        <form id='addForm' method="post" action="${path}/dmcjjc/bgsb/temp">
