...
var editRow = undefined;
    ...
    function saveFun(){
    	...
    	var rows = $("#dataGrid").datagrid("getRows"); 
    	if(rows.length <=0 ){
    		parent.$.messager.alert('提示', '无监测报告上报明细，新增失败。', 'info');
    		return;
    	}
   		if (editRow != undefined) {
               $("#dataGrid").datagrid('endEdit', editRow);
...
<div class="easyui-panel" title="监测报告上报信息" data-options="region:'north',border:false,collapsible:true"  
	...
	<form id="addForm" method="post">
	        <input id="dataSta" value='modified'  type="hidden">
		 	<input id="ifqr" name="ifqr" type="hidden" value="未确认">
            ...
            <table class="grid">
                <tr>
					...
					<td colspan="3" style="width:200px">
						<div style="display: none;"><select editable="false" id="gcbh" name="gcbh" class="easyui-combobox"
					...
					<input id="remarks" name="remarks" class="easyui-textbox" 
                ...
                <tr>
                    ...
                    <input editable="false" id="jcTime" name="jcTime" class="easyui-datetimebox" 
                    	data-options="required:true,prompt:'本次监测时间'" value="${jcTime}" style="width:100%;"/>    
                    </td>
 ...
 <!-- 新增明细时弹出的窗口 -->
<div id="win" class="easyui-window" title="监测报告上报数据" style="width:400px;height:300px"
