...
var dataGrid;
    $(function() {
         ...
         dataGrid = $('#dataGrid').datagrid({
                url : '${path}/dmcjjc/dmcjwxjcinfo/detailList?fid=${jc.id}&jcTime=${jc.jcTime}',
                striped : true,
                rownumbers : true,
                pagination : false,
                singleSelect : false,
                ...
                toolbar : [ 
		    		{
		    			...
		    			handler: function(){
		    				var url = "${path}/dmcjjc/dmcjwxjcinfo/detailExpXls.action?fid=${jc.id}&jcTime=${jc.jcTime}&projectId=${jc.gcbh}";
		...
		<form id="addForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					...
					<td>
					<a href='${path }/dmcjjc/dmcjwxjcinfo/download?filepath=${jc.impFilePath}'>${jc.impFileName}</a>
					</td>
