...
<script type="text/javascript" src="${staticPath }/static/js/zl/up/list.js?time=20170824184233" charset="utf-8"></script>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<!-- 查询表单 -->
	<div class="easyui-panel" title="查询" data-options="region:'north',border:true"  style="width:900px;height:120px;" data-options="collapsible:true">
		<form id="searchForm">
			<input id="upUser" type="hidden" name="upUser" />
            <table class="grid" style="border: 0px">
                ...
                <tr>
                    ...
                    <td class="form-td-content">
                        <input id="upDateStart" name="upDateStart" class="easyui-datebox"  data-options="validType:'equaldDate[\'#upDateEnd\']',prompt:'开始时间'" style="width:140px;">~
                        <input id="upDateEnd" name="upDateEnd" class="easyui-datebox"  data-options="validType:'equaldDate[\'#upDateStart\']',prompt:'结束时间'"  style="width:140px;">
                    </td> 	
                    <td class="form-td-label" >处理状态：</td>
                    <td class="form-td-content" >
                        <select id="search_status" name="status" class="easyui-combobox" data-options="prompt:'请选择处理状态'" style="width: 100%;">
                    ...
                    <td style="text-align: right;" colspan="2">
                        ...
                        <a href="javascript:void(0);" class="easyui-linkbutton"
                           data-options="iconCls:'icon-application_form_delete',plain:true" onclick="cleanFun();">重置</a>
                    </td>
                </tr>
            </table>
		</form>
