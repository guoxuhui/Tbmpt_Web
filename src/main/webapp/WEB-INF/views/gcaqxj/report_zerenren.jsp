...
<head>
  ...
  <title>巡检记录管理</title>
  <script type="text/javascript" src="${staticPath}/static/js/gcaqxj/report_zerenren.js" charset="utf-8"></script>
</head>
...
<div class="easyui-panel" title="查询" data-options="region:'north',border:false"  style="width:50%;height:105px;border: false;overflow: hidden;" data-options="collapsible:true" >
  <form id="searchForm_ZeRenRen" style="display:none">
    <table class="grid" border='0' cellspacing='0' style='width:60%;padding:5px;height: auto;'>
      ...
      <tr>
        ...
        <td align="center" width="120px" >
          <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" onclick="searchForm_ZeRenRenFun();">查询</a>
          <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-application_form_delete',plain:true" onclick="cleandZeRenRenJLFun();">重置</a>
        </td>
      </tr>
    </table>
  </form>
...
<div class="easyui-panel" data-options="region:'center',border:false" style="width:100%;height:100%;">
  <table id="dataGrid_report_zerenren" title="列表" data-options="fit:true,border:false"></table>
</div>
</body>
</html>