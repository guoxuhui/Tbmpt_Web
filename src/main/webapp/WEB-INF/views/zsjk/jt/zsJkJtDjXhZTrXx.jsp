...
<title>刀具消耗总投入信息</title>
<script type="text/javascript" src="${staticPath }/static/js/zsjk/jt/zsJkJtDjXhZTrXx.js" charset="utf-8"></script>
</head>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div class="easyui-panel" title="查询" data-options="region:'north',border:false"  style="width:100%;height:100px;border: false;overflow: hidden;" data-options="collapsible:true">
		<form id="searchForm">
			<table class="grid">
				<tr>
					<td class="form-td-label" style="width: 120px" >刀具消耗实际投入值：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_sjTrz" name="sjTrz" class="easyui-textbox" data-options="prompt:'请输入刀具消耗实际投入值'" style="width: 100%;">
					</td>
					
					<td class="form-td-label" style="width: 120px">刀具消耗计划投入值：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_jhTrz" name="jhTrz" class="easyui-textbox" data-options="prompt:'请输入刀具消耗计划投入值'" style="width: 100%;">
					</td>
					
				</tr>
				<tr>
					<td class="form-td-label" style="width: 120px">年度：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_nd" name="nd" class="easyui-textbox" data-options="prompt:'请输入年度'" style="width: 100%;">
					</td>
	...
	<div id="addDialog" class="easyui-dialog" data-options="iconCls:'icon-save',buttons:'#add-dialog-buttons',closed:true,cache: false,modal: true"
		 style="width:350px;height:200px;padding:5px 5px;" >
        <form id="addForm" method="post" data-options="novalidate:true">
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>刀具消耗计划投入值：</td>
                	<td class="form-td-content">
                    	<input id="add_jhTrz" name="jhTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗计划投入值'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>刀具消耗实际投入值：</td>
                	<td class="form-td-content">
                    	<input id="add_sjTrz" name="sjTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗实际投入值'" style="width:100%">
                	</td>
                </tr>
                 <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>年度：</td>
                	<td class="form-td-content">
                    	<input id="add_nd" name="nd" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入年度'" style="width:100%">
                	</td>
                </tr>
        	</table>
        </form>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>刀具消耗计划投入值：</td>
                	<td class="form-td-content">
                    	<input id="edit_jhTrz" name="jhTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗计划投入值'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>刀具消耗实际投入值：</td>
                	<td class="form-td-content">
                    	<input id="edit_sjTrz" name="sjTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗实际投入值'" style="width:100%">
                	</td>
                </tr>
                 <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>年度：</td>
                	<td class="form-td-content">
                    	<input id="edit_nd" name="nd" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入年度'" style="width:100%">
                	</td>
                </tr>
        	</table>
        </form>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>刀具消耗计划投入值：</td>
                	<td class="form-td-content">
                    	<input id="show_jhTrz" name="jhTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗计划投入值'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>刀具消耗实际投入值：</td>
                	<td class="form-td-content">
                    	<input id="show_sjTrz" name="sjTrz" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入刀具消耗实际投入值'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
                 <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>年度：</td>
                	<td class="form-td-content">
                    	<input id="show_nd" name="nd" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入年度'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
        	</table>
        </form>
        ...
        <input type="hidden" id="filename" />
            <table class="grid">
                ...
                <tr>
                	...
                	<td>
                		<a href="${path }/zsjk/jt/zsJkJtDjXhZTrXx/excelTemplate">点击下载模板</a>
                	</td>
                </tr>
                <tr>
                	<td  colspan="2">
