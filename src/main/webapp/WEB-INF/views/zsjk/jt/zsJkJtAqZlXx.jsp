...
<title>安全质量信息</title>
<script type="text/javascript" src="${staticPath }/static/js/zsjk/jt/zsJkJtAqZlXx.js" charset="utf-8"></script>
</head>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div class="easyui-panel" title="查询" data-options="region:'north',border:false"  style="width:100%;height:100px;border: false;overflow: hidden;" data-options="collapsible:true">
		<form id="searchForm">
			<table class="grid">
				<tr>
					<td class="form-td-label" style="width: 80px">质量问题数：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_zlwts" name="zlwts" class="easyui-textbox" data-options="prompt:'请输入质量问题数'" style="width: 100%;">
					</td>
					<td class="form-td-label" style="width: 80px">安全问题数：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_aqwts" name="aqwts" class="easyui-textbox" data-options="prompt:'请输入安全问题数'" style="width: 100%;">
					</td>
					
				</tr>
				<tr>
					<td class="form-td-label" style="width: 80px" >隐患数：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_yhs" name="yhs" class="easyui-textbox" data-options="prompt:'请输入隐患数'" style="width: 100%;">
					</td>
					<td class="form-td-label" style="width: 80px" >日期：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_rq" name="rq" class="easyui-datebox" data-options="prompt:'请输入上报时间'" style="width: 100%;"/>
					</td>
	...
	<div id="addDialog" class="easyui-dialog" data-options="iconCls:'icon-save',buttons:'#add-dialog-buttons',closed:true,cache: false,modal: true"
        ...
        <form id="addForm" method="post" data-options="novalidate:true">
			<table class="grid">
                ...
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>质量问题数：</td>
                	<td class="form-td-content">
                    	<input id="add_zlwts" name="zlwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入质量问题数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>安全问题数：</td>
                	<td class="form-td-content">
                    	<input id="add_aqwts" name="aqwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入安全问题数'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>隐患数：</td>
                	<td class="form-td-content">
                    	<input id="add_yhs" name="yhs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入隐患数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>日期：</td>
                	<td class="form-td-content">
                    	<input id="add_rq" name="rq" class="easyui-datebox" data-options="editable:false,required:true,prompt:'请输入日期'" style="width:100%">
                	</td>
                </tr>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">
                ...
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>质量问题数：</td>
                	<td class="form-td-content">
                    	<input id="edit_zlwts" name="zlwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入质量问题数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>安全问题数：</td>
                	<td class="form-td-content">
                    	<input id="edit_aqwts" name="aqwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入安全问题数'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>隐患数：</td>
                	<td class="form-td-content">
                    	<input id="edit_yhs" name="yhs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入隐患数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>日期：</td>
                	<td class="form-td-content">
                    	<input id="edit_rq" name="rq" class="easyui-datebox" data-options="editable:false,required:true,prompt:'请输入日期'" style="width:100%">
                	</td>
                </tr>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">
                ...
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>质量问题数：</td>
                	<td class="form-td-content">
                    	<input id="show_zlwts" name="zlwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入质量问题数'" style="width:100%" readonly="readonly">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>安全问题数：</td>
                	<td class="form-td-content">
                    	<input id="show_aqwts" name="aqwts" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入安全问题数'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>隐患数：</td>
                	<td class="form-td-content">
                    	<input id="show_yhs" name="yhs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入隐患数'" style="width:100%" readonly="readonly">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>日期：</td>
                	<td class="form-td-content">
                    	<input id="show_rq" name="rq" class="easyui-datebox" data-options="editable:false,required:true,prompt:'请输入日期'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
        ...
        <input type="hidden" id="filename" />
            <table class="grid">
                ...
                <tr>
                	...
                	<td>
                		<a href="${path }/zsjk/jt/zsJkJtAqZlXx/excelTemplate">点击下载模板</a>
                	</td>
                </tr>
                <tr>
                	<td  colspan="2">
