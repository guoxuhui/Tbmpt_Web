...
<title>施工进度信息</title>
<script type="text/javascript" src="${staticPath }/static/js/zsjk/jt/zsJkJtSgJdXx.js" charset="utf-8"></script>
</head>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div class="easyui-panel" title="查询" data-options="region:'north',border:false"  style="width:100%;height:100px;border: false;overflow: hidden;" data-options="collapsible:true">
		<form id="searchForm">
			<table class="grid">
				<tr>
					<td class="form-td-label" style="width: 120px" >施工进度百分比：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_allXMjdbfb" name="allXMjdbfb" class="easyui-textbox" data-options="prompt:'请输入施工进度百分比'" style="width: 100%;">
					</td>
				</tr>
				<tr>
	...
	<div id="addDialog" class="easyui-dialog" data-options="iconCls:'icon-save',buttons:'#add-dialog-buttons',closed:true,cache: false,modal: true"
        ...
        <form id="addForm" method="post" data-options="novalidate:true">
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>施工进度百分比：</td>
                	<td class="form-td-content">
                    	<input id="add_allXMjdbfb" name="allXMjdbfb" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入施工进度百分比'" style="width:100%">
                	</td>
                </tr>
                <tr>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>施工进度百分比：</td>
                	<td class="form-td-content">
                    	<input id="edit_allXMjdbfb" name="allXMjdbfb" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入施工进度百分比'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>年度：</td>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">         
                <tr>
					<td class="form-td-label"><span style="color: red;">*</span>施工进度百分比：</td>
                	<td class="form-td-content">
                    	<input id="show_allXMjdbfb" name="allXMjdbfb" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入施工进度百分比'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>年度：</td>
        ...
        <input type="hidden" id="filename" />
            <table class="grid">
                ...
                <tr>
                	...
                	<td>
                		<a href="${path }/zsjk/jt/zsJkJtSgJdXx/excelTemplate">点击下载模板</a>
                	</td>
                </tr>
                <tr>
                	<td  colspan="2">
