...
<title>盾构施工人员投入信息</title>
<script type="text/javascript" src="${staticPath }/static/js/zsjk/jt/zsJkJtdgSgRyTrXx.js" charset="utf-8"></script>
</head>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div class="easyui-panel" title="查询" data-options="region:'north',border:false"  style="width:100%;height:100px;border: false;overflow: hidden;" data-options="collapsible:true">
		<form id="searchForm">
			<table class="grid">
				<tr>
					<td class="form-td-label" style="width: 120px">当前项目总数：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_xmZrs" name="xmZrs" class="easyui-textbox" data-options="prompt:'请输入当前项目总数'" style="width: 100%;">
					</td>
					<td class="form-td-label" style="width: 120px">当前盾构队总数：</td>
					<td class="form-td-content" style="width: 160px">
						<input id="search_dgdZs" name="dgdZs" class="easyui-textbox" data-options="prompt:'请输入当前盾构队总数'" style="width: 100%;">
					</td>
					
				</tr>
				<tr>
					<td class="form-td-label" style="width: 120px" >当前盾构队人员总数：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_dgdZrs" name="dgdZrs" class="easyui-textbox" data-options="prompt:'请输入当前盾构队人员总数'" style="width: 100%;">
					</td>
					<td class="form-td-label" style="width: 120px" >平均每个盾构队人数：</td>
					<td class="form-td-content" style="width: 160px" >
						<input id="search_dgdPjrs" name="dgdPjrs" class="easyui-textbox" data-options="prompt:'请输入平均每个盾构队人数'" style="width: 100%;"/>
					</td>
	...
	<div id="addDialog" class="easyui-dialog" data-options="iconCls:'icon-save',buttons:'#add-dialog-buttons',closed:true,cache: false,modal: true"
		 style="width:650px;height:200px;padding:5px 5px;" >
        <form id="addForm" method="post" data-options="novalidate:true">
			<table class="grid">
                
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前项目总数：</td>
                	<td class="form-td-content">
                    	<input id="add_xmZrs" name="xmZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前项目总数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>当前盾构队总数：</td>
                	<td class="form-td-content">
                    	<input id="add_dgdZs" name="dgdZs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队总数'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前盾构队人员总数：</td>
                	<td class="form-td-content">
                    	<input id="add_dgdZrs" name="dgdZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队人员总数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>平均每个盾构队人数：</td>
                	<td class="form-td-content">
                    	<input id="add_dgdPjrs" name="dgdPjrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入平均每个盾构队人数'" style="width:100%">
                	</td>
                </tr>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">
                ...
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前项目总数：</td>
                	<td class="form-td-content">
                    	<input id="edit_xmZrs" name="xmZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前项目总数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>当前盾构队总数：</td>
                	<td class="form-td-content">
                    	<input id="edit_dgdZs" name="dgdZs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队总数'" style="width:100%">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前盾构队人员总数：</td>
                	<td class="form-td-content">
                    	<input id="edit_dgdZrs" name="dgdZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队人员总数'" style="width:100%">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>平均每个盾构队人数：</td>
                	<td class="form-td-content">
                    	<input id="edit_dgdPjrs" name="dgdPjrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入平均每个盾构队人数'" style="width:100%">
                	</td>
                </tr>
        ...
        <input id="id" name="id" type="hidden"/>
			<table class="grid">
                ...
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前项目总数：</td>
                	<td class="form-td-content">
                    	<input id="show_xmZrs" name="xmZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前项目总数'" style="width:100%" readonly="readonly">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>当前盾构队总数：</td>
                	<td class="form-td-content">
                    	<input id="show_dgdZs" name="dgdZs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队总数'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
                <tr>
                	<td class="form-td-label"><span style="color: red;">*</span>当前盾构队人员总数：</td>
                	<td class="form-td-content">
                    	<input id="show_dgdZrs" name="dgdZrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入当前盾构队人员总数'" style="width:100%" readonly="readonly">
                	</td>
					<td class="form-td-label"><span style="color: red;">*</span>平均每个盾构队人数：</td>
                	<td class="form-td-content">
                    	<input id="show_dgdPjrs" name="dgdPjrs" class="easyui-textbox" data-options="editable:true,required:true,prompt:'请输入平均每个盾构队人数'" style="width:100%" readonly="readonly">
                	</td>
                </tr>
        ...
        <input type="hidden" id="filename" />
            <table class="grid">
                ...
                <tr>
                	...
                	<td>
                		<a href="${path }/zsjk/jt/zsJkJtdgSgRyTrXx/excelTemplate">点击下载模板</a>
                	</td>
                </tr>
                <tr>
                	<td  colspan="2">
