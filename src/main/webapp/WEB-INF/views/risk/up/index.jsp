...
<title>风险上报管理</title>   
<script type="text/javascript" src="${staticPath }/static/js/risk/up/list.js?v=20170830202457" charset="utf-8"></script>
</head> 
<jsp:include  page="../../sys/base/uploadPicture.jsp" />
<body class="easyui-layout" data-options="fit:true,border:false">
	<!-- 筛选表单 -->
	<div class="easyui-panel" title="筛选" data-options="region:'north',border:false"  style="width:100%;height:105px;border: false;overflow: hidden;" data-options="collapsible:true">
        <form id="searchForm">
			<table class="grid">
				<tr>
				    <td class="form-td-label" style="width: 80px">项目名称：</td>
					<td class="form-td-content" style="width: 180px">
						<input id="search_proName" name="proName" class="easyui-textbox" data-options="prompt:'--请选择--'" style="width: 100%;"/>
					</td>
					<td class="form-td-label" style="width: 80px">填报时间：</td>
					<td class="form-td-content" style="width: 180px">
						<input id="search_startUpTime" name="startUpTime" class="easyui-datebox" data-options="required:true,prompt:'--请选择--'" style="width:100%;">
					</td>	
					<td class="form-td-content" style="width: 180px">
						<input id="search_endUpTime" name="endUpTime" class="easyui-datebox" data-options="required:true,prompt:'--请选择--'" style="width:100%;">
					</td>
					<td class="form-td-label" style="width: 80px;display: none;">上报人：</td>
					<td class="form-td-content" style="width: 180px;display: none;">
						<input id="search_proState" name="upUser" class="easyui-textbox"  data-options="prompt:'请输入上报人'" style="width: 100%" />
					</td>
					<td class="form-td-label" style="width: 80px">监控时段：</td>
					<td class="form-td-content" style="width: 280px">
						<input id="rikeTimeStart" name="rikeTimeStart" class="easyui-datebox" data-options="prompt:'开始时间'" style="width:100px;">~
						<input id="rikeTimeEnd" name="rikeTimeEnd" class="easyui-datebox" data-options="prompt:'结束时间'" style="width:100px;">
					</td>
				</tr>
				<tr>
				    <td class="form-td-label" style="width: 80px">排除状态：</td>
					<td class="form-td-content" style="width: 180px">
						<select  name="isOut" class="easyui-combobox" data-options="prompt:'请选择排除状态'" style="width: 100%;">
							<option value="">--请选择--</option>
						   <option value="0">未排除</option>
						   <option value="1">已排除</option>
						</select>
					</td>
					<td class="form-td-label" style="width: 80px">风险级别：</td>
					<td class="form-td-content" style="width: 180px">
					    <select id="search_riskLevel" name="rikeLevel" class="easyui-combobox" data-options="prompt:'--请选择--'" style="width: 100%;">
						</select>
					</td>
        ...
        <form id="addForm" method="post" data-options="novalidate:true">
            ...
            <table class="grid">
            		<tr>
	                	...
	                	<td class="form-td-content" style="width:180px">
	                		<input id="add_riskLevel" name="rikeLevel" class="easyui-textbox" data-options="prompt:'请选择风险级别(选填)'" style="width: 100%;"/>
	                	</td>
            		</tr>
                <tr>
                		<td class="form-td-label" style="width:100px"><span style="color: red;">*</span>安全质量风险:</td>
                    <td class="form-td-content" colspan="3" >
                    		<input name="rikeDesc" validType="length[0,400]" class="easyui-textbox" data-options="required:true,prompt:'请输入安全质量风险(400字以内)'" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="form-td-content" >
                    	...
                    	<select id="add_isOut" name="isOut" class="easyui-combobox" data-options="required:true,prompt:'请选择状态'" style="width: 100%;">
					     <option value="0" style="width:120px;height:30px; color: green;">未排除</option>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="form-td-content"  colspan="3">
                    	<input name="mainControlMethod" class="easyui-textbox" data-options="required:true,prompt:'请输入主要管控措施(800字以内)',multiline:true" validType="length[0,800]" style="width:100%;height:80px">
                    </td>
                </tr>
                <tr >
                	<td class="form-td-label" style="width:100px">备注:</td>
                    <td class="form-td-content"  colspan="3">
                    	<input name="remark" class="easyui-textbox" data-options="required:false,prompt:'请输入备注(800字以内)',multiline:true" validType="length[0,800]" style="width:100%;height:80px">
                    </td>
                </tr>
        ...
        <input id="edit_section" name="section" type="hidden" value="">
            ...
            <table class="grid">
	            	<tr>
	                	...
	                	<td class="form-td-label" style="width:100px"><span style="color: red;"></span>安全风险级别:</td>
	                	<td class="form-td-content" style="width:180px">
	                		<input id="edit_riskLevel" name="rikeLevel" class="easyui-textbox" data-options="prompt:'请选择级别(选填)'" style="width: 100%;"/>
	                	</td>
	            	</tr>
                <tr>
                	<td class="form-td-label" style="width:100px"><span style="color: red;">*</span>安全质量风险:</td>
                    <td class="form-td-content" colspan="3">
                    	<input name="rikeDesc" class="easyui-textbox" validType="length[0,400]" data-options="required:true,prompt:'请输入安全质量风险(400字以内)'" style="width:100%;">
                    </td>
                </tr>
                <tr>
                	<td class="form-td-label" style="width:100px"><span style="color: red;">*</span>监控时段:</td>
        	...
        	<input name="id" type="hidden">
                ...
                <tr>
                    ...
                    <td class="form-td-content" colspan="5" style="width:280px">
                    	<input name="rikeDesc" class="easyui-textbox" data-options="required:true,prompt:'请输入安全质量风险'" validType="length[0,200]" style="width:100%;">
                    </td>
                </tr>
                <tr>
                	<td class="form-td-label" style="width:100px"><span style="color: red;">*</span>监控时段:</td>
